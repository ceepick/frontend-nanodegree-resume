...
var HTMLheaderName '<h1 id="name" class="yellow-text">%data%</h1>';
  ...
  */
    ...
    function createMapMarker(placeData) {
        ...
        var marker new google.maps.Marker( {
            map: map, position: placeData.geometry.location, title: name
        }
        );
        ...
        bounds.extend(new google.maps.LatLng(lat,
        lon));
